...
namespace projekt
{
    public partial class negyedikoldal : UserControl
    {
        ...
        private void negyedikoldal_Load(object sender, EventArgs e)
        {
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            if (isChanged)
            {
                ...
                item.SubItems.Add(Convert.ToString(sum));
        ...
        private void EndSum()
        {
            ...
            try
            {
                ...
                textBox1.Text = Convert.ToString(sumtemp + " Ft");
            }
            catch
            {
                textBox1.Text = "";
        ...
        private void Excl_Click(object sender, EventArgs e)
        {
            ...
            using (SaveFileDialog sfd = new SaveFileDialog() { Filter = "Excel Workbook|*.xlsx", ValidateNames = true })
            {
                if (sfd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    app.Quit();
                    MessageBox.Show("Exportálva", "Üzenet", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
